    ...
    <>
      <div className="min-h-screen flex flex-col">
        <div className="flex-grow relative">
          <img src="/static/assets/photo-1460317442991-0ec209397118.avif" alt="Full screen" className="w-full h-screen object-cover mt-14" style={{ height: 'calc(100vh - 4rem)' }} />
      ...
      <div className="flex flex-wrap mt-10 md:mt-20 px-4">
        <div className="w-full md:w-1/2 mb-10 md:mb-0">
          <img src="/static/assets/photo-1560448204-e02f11c3d0e2.avif" alt="" className="rounded-lg mx-auto" style={{ width: '100%', maxWidth: '400px', height: 'auto' }} />
        </div>
      ...
      <div className="flex flex-wrap justify-center mx-4 md:mx-20">
        {[
          { src: "/static/assets/Single_Family.png", alt: "Single Family", text: "Single-Family" },
          { src: "/static/assets/Multifamily.png", alt: "Multi Family", text: "Multi Family" },
          { src: "/static/assets/Affordable_Housing.png", alt: "Affordable Housing", text: "Affordable Housing" },
          { src: "/static/assets/CA.png", alt: "Community Association", text: "Community Association" }
        ].map(({ src, alt, text }) => (
      ...
      <div className="flex flex-wrap justify-center mx-4 md:mx-20 mb-20">
        {[
          { src: "/static/assets/Student_Housing.png", alt: "Student Housing", text: "Student Housing" },
          { src: "/static/assets/Commercial.png", alt: "Commercial", text: "Commercial" },
          { src: "/static/assets/Investment_Manager.png", alt: "Investment Manager", text: "Investment Manager" }
        ].map(({ src, alt, text }) => (
          <div key={alt} className="flex flex-col items-center w-1/2 md:w-1/4 mb-10">
            <img src={src} alt={alt} className="w-24 h-auto sm:w-32 md:w-48 lg:w-56 mx-auto" />
            <p className="mt-2 text-sm md:text-base">{text}</p>
