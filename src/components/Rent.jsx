...
const Rent = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post(`${BASE_URL}/api/stk-push/`, {
                contact,
                amount,
            });
    ...
    <h1 className="text-3xl font-bold">RENT</h1></div>
    ...
    <div className=' mt-20 mb-60 max-w-sm mx-auto'>
                    <form className="mx-auto" onSubmit={handleSubmit}>
                        <h1 className='text-center text-lg text-black pb-3'><b></b></h1>
                        <div className='mb-4'>
